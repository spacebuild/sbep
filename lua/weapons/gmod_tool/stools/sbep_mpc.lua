...
if CLIENT then
	language.Add( "tool.sbep_mpc.name"	, "SBEP MPC Tool" 				)
	language.Add( "tool.sbep_mpc.desc"	, "Create an SBEP Mobile Platform Controller." 		)
	language.Add( "tool.sbep_mpc.0"		, "Left-click to spawn an MPC. Right-click to copy the model of whatever you're looking at, or Shift-Right-click to replace the target prop with an MPC." )
