...
function ENT:Draw()
	...
	self:SetModel( "models/SmallBridge/Wings/SBwingC1R.mdl" ) 
	self:DrawModel()
	...
	self:SetModel( "models/SmallBridge/Wings/SBwingM1R.mdl" ) 
	...
	self:SetModel( "models/SmallBridge/Wings/SBwingM1Re.mdl" ) 
	local NAng = OAng - Angle( 0.01, 0.01, 0.01 )
	self:SetAngles( NAng )
	NAng:RotateAroundAxis( self:GetForward(), -CAngle )
	self:SetAngles( NAng )
